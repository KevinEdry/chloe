...
pub struct KanbanState {
    ...
    #[serde(skip)]
    pub pending_worktree_deletion: Option<crate::views::worktree::WorktreeInfo>,
    #[serde(skip)]
...
impl KanbanState {
    ...
    pub fn get_selected_task(&self) -> Option<&Task> {
        self.selected_task
            .and_then(|i| self.columns[self.selected_column].tasks.get(i))
    }
...
pub struct Task {
    ...
    pub is_paused: bool,
    #[serde(default)]
    pub worktree_info: Option<crate::views::worktree::WorktreeInfo>,
}
