use crate::app::App;
use crate::views::focus::state::FocusReviewAction;
...
pub fn render(
    ...
    let task = find_task_by_id(app, task_id);
...
fn find_task_by_id(app: &App, task_id: Uuid) -> Option<&crate::views::kanban::Task> {
    for column in &app.kanban.columns {
