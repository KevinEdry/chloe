...
export const metadata = {
  ...
  description: 'Practical patterns for using Chloe effectively. Learn how to run multiple AI coding agents in parallel, manage git worktrees, and optimize your AI-assisted development workflow.',
  keywords: ['Chloe workflows', 'AI coding agents', 'Claude Code', 'Gemini CLI', 'parallel development', 'git worktree', 'AI development workflow', 'multi-agent orchestration'],
  alternates: { canonical: '/docs/common-workflows' },
}
...
## Running Multiple AI Coding Agents

The primary use case for Chloe is orchestrating multiple AI coding agent sessions working on different parts of your project.
...
### Start AI agents in each pane

- Press `Enter` to focus a pane
- Start your preferred AI agent (Claude Code, Gemini CLI, Amp, OpenCode, etc.)
...
**Work in parallel**
- Different AI agent instances can work on different tasks
...
2. Do your work with your AI agent
