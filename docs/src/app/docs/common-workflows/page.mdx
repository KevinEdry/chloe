...
export const metadata = {
  ...
  description: 'Practical patterns for using Chloe effectively. Learn how to run multiple Claude Code instances, manage git worktrees, and optimize your AI-assisted development workflow.',
  keywords: ['Chloe workflows', 'Claude Code patterns', 'parallel development', 'git worktree', 'AI development workflow'],
