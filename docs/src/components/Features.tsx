    ...
    <section className="relative max-w-[1208px] mx-auto px-6 py-20">
      ...
      <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 list-none">
          ...
          <Feature
            ...
            description={
              <>
                Navigate with <kbd className="px-1.5 py-0.5 text-xs rounded bg-[var(--color-surface)] border border-[var(--color-border)]">h</kbd>{' '}
                <kbd className="px-1.5 py-0.5 text-xs rounded bg-[var(--color-surface)] border border-[var(--color-border)]">j</kbd>{' '}
                <kbd className="px-1.5 py-0.5 text-xs rounded bg-[var(--color-surface)] border border-[var(--color-border)]">k</kbd>{' '}
                <kbd className="px-1.5 py-0.5 text-xs rounded bg-[var(--color-surface)] border border-[var(--color-border)]">l</kbd> or arrow keys
              </>
            }
          />
